 ...
 */
    ...
    public:
        ...
        CoinSpend(const ZerocoinParams *paramsV1, const ZerocoinParams *paramsV2, Stream &strm) :
                ...
                commitmentPoK(&paramsV1->serialNumberSoKCommitmentGroup,
                              &paramsV2->accumulatorParams.accumulatorPoKCommitmentGroup) {
            ...
            if (serialVersion >= PrivateCoin::PUBKEY_VERSION) {
                ...
                commitmentPoK = CommitmentProofOfKnowledge(&paramsV2->serialNumberSoKCommitmentGroup,
                                                           &paramsV2->accumulatorParams.accumulatorPoKCommitmentGroup);
                strmCopy >> *this;
            }
        }
