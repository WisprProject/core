...
#ifdef ENABLE_WALLET
        {"wispr", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use wisprd, or the -server option to wispr-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
