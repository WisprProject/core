...
Add(test::RandomKey(&rnd, rnd.Skewed(4)),
        test::RandomString(&rnd, rnd.Skewed(5), &v)
.
...
char name[100];
snprintf(name,
sizeof(name), "leveldb.num-files-at-level%d", level);
...
WriteBatch batch;
WriteBatchInternal::SetSequence(&batch,
100);
batch.
