...
#error Client version information missing: version is not defined by wispr-config.h or in any other way
#endif
...
/**
 * wisprd-res.rc includes this file, but it cannot cope with real c++ code.
