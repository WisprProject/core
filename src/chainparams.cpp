...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (75000, unit256("06f162fe22851c400c1532a6d49d7894640ea0aa292fad5f02f348480da6b20d")) // Block 75.000
    (100000, unit256("ed8cccfb51c901af271892966160686177a05f101bd3fd517d5b82274a8f6611")) // Block 100.000
    (125000, unit256("76d5412ec389433de6cd22345209c859b4c18b6d8f8893df479c9f7520d19901")) // Block 125.000
    (150000, unit256("a7e0dfdc9c3197e9e763e858aafa9553c0235c0e328371a5f8c5ba0b6e44919d")); // Block 150.000
...
//        nSubsidyHalvingInterval = 210000; // TODO: delete this
        ...
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0x31)(0x2B).convert_to_container<std::vector<unsigned char> >();
        // 	BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        // TODO: Check deterministic wallet
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x06)(0xB0).convert_to_container<std::vector<unsigned char> >();

        // TODO: Add some DNS seed nodes
        ...
        //TODO: Generate new spork key
        //You will need to generate a new keypair (using any of several libraries available, or masternode genkey for example) and start your Wispr-Qt client using the -sporkkey option and passing it the private key in WIF format.
        //You'll have to hard-code the corresponding public key into chainparams.cpp, replacing the existing public key.
