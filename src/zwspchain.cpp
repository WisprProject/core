...
{
    return Params().NEW_PROTOCOLS_STARTHEIGHT();
}
...
libzerocoin::CoinSpend TxInToZerocoinSpend(const CTxIn& txin)
{
    ...
    libzerocoin::ZerocoinParams* paramsAccumulator = Params().Zerocoin_Params(chainActive.Height() < Params().NEW_PROTOCOLS_STARTHEIGHT());
