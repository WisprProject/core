...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, CAmount nZerocoinBalance, QString &sPIVPercentage,
                                 QString &szPIVPercentage) {
    int nPrecision = 2;
