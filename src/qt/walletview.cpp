...
void WalletView::setBitcoinGUI(BitcoinGUI *gui) {
    if (gui) {
        ...
        connect(this, SIGNAL(incomingTransaction(QString, int, CAmount, QString, QString)), gui,
...
void WalletView::setWalletModel(WalletModel *walletModel) {
    ...
    if (walletModel) {
        ...
        connect(walletModel, SIGNAL(message(QString, QString, unsigned int)), this,
                SIGNAL(message(QString, QString, unsigned int)));
        ...
        connect(walletModel, SIGNAL(requireUnlock(AskPassphraseDialog::Context)), this,
                SLOT(unlockWallet(AskPassphraseDialog::Context)));
