...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-wispr executable and locales:
    Delete /REBOOTOK $INSTDIR\wispr.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\wispr-qt.exe
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\wispr-qt.exe
